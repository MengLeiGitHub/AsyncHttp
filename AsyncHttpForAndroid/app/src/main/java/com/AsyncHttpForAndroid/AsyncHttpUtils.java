...
public class AsyncHttpUtils {
    ...
    public static  <T> void upload(String url, String path, String fileName, final UploadRequestResultCallBack<T> uploadProgrossCallback) {
        if (!isInit) init();
       ...
       // String filepath = path;
        ...
        AsyncHttp.instance().UploadRequest(resReques, uploadCallBack);
    }



    public static <T> void string(String url, HttpMethod httpMethod, HashMap<String, String> hashMap, final StringRequestResultCallBack<T> httpCallBack) {
      //  if (!isInit) init();
        ...
        UploadCallBack uploadCallBack = new UploadCallBack<String>(handler, indexs);
        AsyncHttp.instance().stringRequest(resReques, uploadCallBack);
    }
    ...
    public static <T> void json(String url, HttpMethod httpMethod, HashMap<String, String> hashMap, final StringRequestResultCallBack<T> httpCallBack) {
        if (!isInit) init();
