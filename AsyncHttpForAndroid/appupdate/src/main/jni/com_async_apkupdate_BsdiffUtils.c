...
/* Header for class com_async_apkupdate_utils_BsdiffUtils */
...
#include "com_async_apkupdate_BsdiffUtils.h"
...
/*
 * Class:     com_async_apkupdate_utils_BsdiffUtils
 * Method:    patch
 * Signature: (Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)I
 */
JNIEXPORT jint JNICALL Java_com_async_apkupdate_BsdiffUtils_patch
  (JNIEnv *env, jobject cls, jstring old, jstring new, jstring  patch){
    const char *str = (*env)->GetStringUTFChars(env, patch, NULL);
    __android_log_print(ANDROID_LOG_ERROR, "JNITag","string From Java To C : %s", str);
