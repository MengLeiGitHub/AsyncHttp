...
import com.async.clientImpl.BoundaryBuilder;
...
public abstract class BaseParamPart<T> {
		...
		public void write(OutputStream output,BaseHttpRequest<?> reqest) throws IOException{
			Log.e(new String(head).toString());
		...
		public abstract void  writeContent(OutputStream output,BaseHttpRequest<?> reqest) throws IOException;
