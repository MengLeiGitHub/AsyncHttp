...
import com.async.http.requsetcreator.parseType.method.impl.DeleteMethodParse;
import com.async.http.requsetcreator.parseType.method.impl.DownloadMethodParse;
import com.async.http.requsetcreator.parseType.method.impl.GetMethodParse;
import com.async.http.requsetcreator.parseType.method.impl.HeadMethodParse;
import com.async.http.requsetcreator.parseType.method.impl.OptionsMethodParse;
import com.async.http.requsetcreator.parseType.method.impl.PatchMethodParse;
import com.async.http.requsetcreator.parseType.method.impl.PostMethodParse;
import com.async.http.requsetcreator.parseType.method.impl.PutMethodParse;
import com.async.http.requsetcreator.parseType.method.impl.TraceMethodParse;
import com.async.http.requsetcreator.parseType.method.impl.UploadMethodParse;
